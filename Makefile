STRIP=strip
XDEFINES= -DLIBOPENSSL -DHAVE_PCRE -DLIBSVN -DNO_RSA_LEGACY -DHAVE_ZLIB -DHAVE_MATH_H -DHAVE_SYS_PARAM_H
XLIBS= -lz -lssl -lpcre2-8 -lsvn_client-1 -lapr-1 -laprutil-1 -lsvn_subr-1 -lcrypto
XLIBPATHS=-L/usr/lib -L/usr/local/lib -L/opt/homebrew/lib
XIPATHS= -I/opt/homebrew/include -I/opt/homebrew/include -I/opt/homebrew/include/subversion-1 -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/apr-1 -I/opt/homebrew/include/subversion-1
PREFIX=/usr/local
XHYDRA_SUPPORT=
STRIP=strip
